  ...
  return (
    <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
        ...
        <View className='flex flex-row items-center bg-white/90 px-3 py-1.5 rounded-full absolute top-5 right-5'>
          ...
          <Text className='text-xs font0rubik-bold text-primary-300 ml-1'>4.4</Text>
        </View>

        <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
          <Text className='text-xl font-rubik-extrabold text-white' numberOfLines={1}>Modern Apartment</Text>
          <Text className='text-base font-rubik text-white'>22 W 15th St, New York, NY</Text>
  ...
  return (
    <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-4 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'> 
      <View className='flex flex-row items-center absolute px-2 top-5 right-5 bg-white/90 p-1 rounded-full z-50'>
          ...
          <Text className='text-xs font0rubik-bold text-primary-300 ml-0.5'>4.4</Text>
        </View>
        ...
        <View className='flex flex-col mt-2'>
          ...
          <Text className='text-xs font-rubik text-black-200'>22 W 15th St, New York, NY</Text>
